...
public class Auditorium extends Venue{
    ...
    public Auditorium(String venueName, String venueType, int capacity, double cost) {
     ...
     * @param fireworksCost
     */
    public Auditorium(String venueName, double seatsUnavailablePct, String venueType, int capacity, double cost, int vipPct, int goldPct, int silverPct,
