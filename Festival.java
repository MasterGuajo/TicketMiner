...
public class Festival extends Event {
    ...
    public Festival(int eventId, String eventType, String name, String date, String time, double generalAdmissionPrice, Venue venue){
     ...
     * @param venue
     */
    public Festival(int eventId, String eventType, String name, String date, String time, double vipPrice, double goldPrice, double silverPrice, double bronzePrice, double generalAdmissionPrice, Venue venue, double convenienceFee, double serviceFee, double charityFee){
