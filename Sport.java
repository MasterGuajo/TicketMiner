...
public class Sport extends Event{
    ...
    /**
     * Contrsuctor suppers all info to parent class
     * 
     * @author Jorge Garcia
     * @author Jazmin Huerta
     * @author Isabella Garcia
     ...
     * @param venue
     */
    public Sport(int eventId, String eventType, String name, String date, String time, double generalAdmissionPrice, Venue venue){
     ...
     * @param venue
     */
    public Sport(int eventId, String eventType, String name, String date, String time, double vipPrice, double goldPrice, double silverPrice, double bronzePrice, double generalAdmissionPrice, Venue venue, double convenienceFee, double serviceFee, double charityFee){
